...
def verify_file_integrity(torrent_file_path, downloaded_file_path):
    """
...
if __name__ == '__main__': # Corrected this line
    ...
    try:
        ...
        verification_result = verify_file_integrity(dummy_torrent_path, dummy_downloaded_path)
        ...
        verification_result_incomplete = verify_file_integrity(dummy_torrent_path, incomplete_downloaded_path)
        ...
        verification_result_corrupted = verify_file_integrity(dummy_torrent_path, corrupted_downloaded_path)
